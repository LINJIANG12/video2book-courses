...
- **第 1 章**：Day11-11.迁移学习_中文分类案例_数据加载(掌握)
- **第 2 章**：Day11-12.迁移学习_中文分类案例_数据预处理(掌握)
- **第 3 章**：Day12-01.迁移学习_中文分类案例_模型搭建(掌握)
- **第 4 章**：Day12-02.迁移学习_中文分类案例_模型训练(掌握)
- **第 5 章**：Day12-03.迁移学习_中文分类案例_模型评估(掌握)
- **第 6 章**：Day12-04.迁移学习_中文填空案例_数据预处理(掌握)
- **第 7 章**：Day12-05.迁移学习_中文填空案例_模型搭建(掌握)
- **第 8 章**：Day12-06.迁移学习_中文填空案例_模型训练(掌握)
- **第 9 章**：Day12-07.迁移学习_中文填空案例_模型评估(掌握)
- **第 10 章**：Day12-08.迁移学习_NSP案例_自定义数据集对象(掌握)
- **第 11 章**：Day12-09.迁移学习_NSP案例_数据预处理(掌握)
- **第 12 章**：Day12-10.迁移学习_NSP案例_模型搭建(掌握)
- **第 13 章**：Day12-11.迁移学习_NSP案例_模型训练和评估(掌握)
